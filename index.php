...
<body>
    ...
    <form class="w-50 offset-3 mt-3" class=" form myform" id="myform">
        <div class="mb-3">
    ...
    $(document).ready(function() {
        $('#myform').submit(function(e) {
            ...
            var fn = $('input#name').val()
            var file = $('input#image');
            ...
            $.ajax({
                url: "http://localhost:8080/fileuploading_with_ajax/api.php",
                type: "POST",
                cache: false,
                contentType: false,
                processData: false,
